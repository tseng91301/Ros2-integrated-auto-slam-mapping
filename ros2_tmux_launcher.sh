...
docker exec isaac_ros_dev_container pkill -f [b]ase_control_node 2>/dev/null || true
docker exec isaac_ros_dev_container pkill -f [b]in/ros2 2>/dev/null || true
docker exec isaac_ros_dev_container pkill -f [j]oint_state_publisher 2>/dev/null || true
docker exec isaac_ros_dev_container pkill -f [w]heeltec_keyboard 2>/dev/null || true
docker exec isaac_ros_dev_container pkill rviz2 2>/dev/null || true
sleep 1
